...
def main(args):
    ...
    entity2id, relation2id, train_triplets, valid_triplets, test_triplets = load_data(args.data_path)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='RGCN for OntoOmicsKG')
