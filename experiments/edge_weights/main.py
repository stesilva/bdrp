...
def main(args):
    ...
    for epoch in trange(1, (args.n_epochs + 1), desc='Epochs', position=0):
        ...
        if epoch % args.evaluate_every == 0:
            tqdm.write(f"Train Loss {loss.item()} at epoch {epoch}")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--edge-weight-mode", type=str, default="none",
                        choices=["normalize", "concat", "none", "learnable"],
                        help="Edge weight usage mode: 'normalize' for normalized weights, 'concat' to concatenate edge weights to features, 'none' for raw unnormalized multipliers.")
