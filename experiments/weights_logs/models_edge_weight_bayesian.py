    ...
    def message(self, x_j, edge_index_j, edge_type, edge_weight):
        ...
        if x_j is None:
            ...
            if self.edge_weight_mode == "concat":
                ...
                # Transform weights
                transformed_weight = self.edge_weight_mlp(edge_weight)
                ...
                weight_mean = self.edge_weight_mean_mlp(edge_weight)
                weight_var_raw = self.edge_weight_var_mlp(edge_weight)
                weight_var = weight_var_raw * torch.abs(self.var_scale) + 1e-6
