...
#SBATCH --job-name=rgcn_cn15k_bayesian
...
echo "======================================================================"
echo "Starting RGCN Training with Bayesian Edge Weights"
echo "======================================================================"
echo "Working directory: $(pwd)"
echo "Script:            main_bayesian.py"
echo "Edge weight mode:  bayesian (uncertainty-aware)"
...
# Run the training script with GPU enabled and Bayesian edge weights
...
# --edge-weight-mode bayesian is the default in main_bayesian.py, but we specify it explicitly
python main_bayesian.py --gpu 0 --edge-weight-mode bayesian --test-graph-size -1 2>&1 || {
    EXIT_STATUS=$?
    echo ""
    echo "======================================================================"
